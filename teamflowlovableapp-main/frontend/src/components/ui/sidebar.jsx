  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] md-data-[variant=inset]:m-2 md-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md-data-[variant=inset]:ml-0 md-data-[variant=inset]:rounded-xl md-data-[variant=inset]:shadow",
        className,
      )}
      {...props}
    />
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opa] duration-200 ease-linear focus-visible-2 [&>svg]:size-4 [&>svg]:shrink-0",
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          "absolute right-3 top-3.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover-sidebar-accent hover-sidebar-accent-foreground focus-visible-2 [&>svg]:size-4 [&>svg]:shrink-0",
          // Increases the hit area of the button on mobile.
          "after after:-inset-2 after:hidden",
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform peer-hover/menu-button-sidebar-accent-foreground hover-sidebar-accent hover-sidebar-accent-foreground focus-visible-2 [&>svg]:size-4 [&>svg]:shrink-0",
        // Increases the hit area of the button on mobile.
        "after after:-inset-2 after:hidden",
        ...
        "group-data-[collapsible=icon]:hidden",
        showOnHover &&
          "group-focus-within/menu-item-100 group-hover/menu-item-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button-sidebar-accent-foreground md-0",
        className,
      )}
      {...props}
    />
